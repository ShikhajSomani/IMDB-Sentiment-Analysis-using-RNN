...
A deep learning project that performs sentiment analysis on IMDB movie reviews using Recurrent Neural Networks (RNN) and SimpleRNN architecture. This project includes both training notebooks and a Streamlit web application for real-time predictions.

## 🎯 Project Overview

This project implements a sentiment classification model that predicts whether a movie review is positive or negative using the IMDB dataset. The model uses a SimpleRNN architecture with embedding layers to process sequential text data and classify sentiment with high accuracy.

**Key Features:**
- Sentiment classification (Positive/Negative)
- Deep learning with TensorFlow/Keras
- SimpleRNN and embedding layers
...
Run the Streamlit app with the pre-trained model:
